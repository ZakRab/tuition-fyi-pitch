    ...
    <div className="w-full max-w-5xl mx-auto px-16">
      ...
      <div className="grid grid-cols-3 gap-8">
        <div className="bg-gray-50 rounded-2xl p-8">
          <p className="text-xl text-gray-500 uppercase font-semibold tracking-wider mb-4">Current Students</p>
        ...
        <div className="bg-gray-50 rounded-2xl p-8">
          <p className="text-xl text-gray-500 uppercase font-semibold tracking-wider mb-4">Token Recipients</p>
