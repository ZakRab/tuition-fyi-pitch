  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-16">
      ...
      <div className="space-y-10">
        <div>
          <h3 className="text-4xl font-bold text-[#cc0000] mb-3">Universities benefit from the opacity.</h3>
        ...
        <div>
          <h3 className="text-4xl font-bold text-[#cc0000] mb-3">Students are embarrassed to share.</h3>
          <ul className="text-3xl text-gray-600 space-y-2">
        ...
        <div>
          <h3 className="text-4xl font-bold text-[#cc0000] mb-3">The alternatives have conflicts of interest.</h3>
          <ul className="text-3xl text-gray-600 space-y-2">
