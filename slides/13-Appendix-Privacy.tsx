    ...
    <div className="w-full max-w-5xl mx-auto px-16">
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-start gap-6">
          ...
          <div>
            <p className="text-4xl font-bold">User confirms extracted data</p>
            <p className="text-3xl text-gray-500 mt-1">They see tuition, scholarships, net cost. They approve before anything is sent.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-6">
          <div className="w-14 h-14 rounded-full bg-[#cc0000] text-white flex items-center justify-center font-bold text-2xl shrink-0 mt-1">4</div>
          <div>
            <p className="text-4xl font-bold">Document hash for verification</p>
            <p className="text-3xl text-gray-500 mt-1">SHA-256 hash stored as proof a real document was processed. Can&rsquo;t be reversed.</p>
          </div>
        </div>
      </div>
    </div>
