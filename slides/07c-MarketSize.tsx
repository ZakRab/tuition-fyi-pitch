    ...
    <div className="w-full max-w-6xl mx-auto px-12">
      ...
      <div className="bg-gray-50 rounded-2xl p-5 mb-5">
        <div className="flex items-baseline justify-between mb-3">
          <p className="text-xl text-gray-600 font-semibold">Total Addressable Market</p>
          <p className="text-5xl font-black text-gray-900">$700M+</p>
        </div>
        <div className="border-t border-gray-200 pt-3 space-y-2">
          <div className="flex items-baseline justify-between">
            <p className="text-base text-gray-500">Full US TAM (6,000 Title IV schools, 30% consumer)</p>
            <p className="text-2xl font-bold text-gray-800">$328M</p>
          </div>
          <div className="flex items-baseline justify-between">
            <p className="text-base text-gray-500">Mature US (500 schools + same consumer)</p>
            <p className="text-2xl font-bold text-gray-800">$38.5M</p>
          </div>
          <div className="flex items-baseline justify-between">
            <p className="text-base text-gray-500">Mid-term combined ARR</p>
            <p className="text-2xl font-bold text-gray-800">$23.5M</p>
          </div>
        </div>
      </div>
