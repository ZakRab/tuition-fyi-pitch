  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-16">
      ...
      <div className="grid grid-cols-3 gap-10">
        <div>
          <p className="text-[#cc0000] font-bold text-2xl uppercase tracking-wider mb-2">April 2026</p>
          <h3 className="text-4xl font-bold mb-6">Launch</h3>
          <ul className="space-y-3 text-3xl text-gray-600 list-disc list-outside pl-6">
            ...
            <li>Begin pre-populating data</li>
            <li>Launch at UNL</li>
          </ul>
        </div>
        <div>
          <p className="text-[#cc0000] font-bold text-2xl uppercase tracking-wider mb-2">Summer 2026</p>
          <h3 className="text-4xl font-bold mb-6">Grow</h3>
          <ul className="space-y-3 text-3xl text-gray-600 list-disc list-outside pl-6">
