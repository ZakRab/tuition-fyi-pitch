export default function Close() {
  return (
    <div className="w-full max-w-4xl mx-auto px-16 text-center">
      ...
      <p className="text-5xl font-bold text-[#1a1a1a] mb-8 leading-relaxed">
      ...
      <div className="flex justify-center gap-20 mb-12">
        <div>
          <p className="text-4xl font-bold">Zak Rab</p>
          <p className="text-3xl text-gray-500">Co-founder</p>
        </div>
        <div>
          <p className="text-4xl font-bold">Joey Shea</p>
          <p className="text-3xl text-gray-500">Co-founder</p>
        </div>
      </div>
