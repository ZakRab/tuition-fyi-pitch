    ...
    <div className="w-full max-w-5xl mx-auto px-16">
      ...
      <div className="space-y-6 mb-12">
        <div className="border-l-4 border-[#cc0000] pl-6">
          <p className="text-3xl italic text-gray-700">&ldquo;You pay fees in USD, 5-6x my currency, before you know your scholarship.&rdquo;</p>
        ...
        <div className="border-l-4 border-[#cc0000] pl-6">
          <p className="text-3xl italic text-gray-700">&ldquo;Finding contacts at different schools was nearly impossible.&rdquo;</p>
      ...
      <div className="grid grid-cols-3 gap-8 text-center">
        ...
        <div>
          ...
          <p className="text-3xl text-gray-500 mt-2">no one to talk to</p>
        </div>
        <div>
